...
import io.lfa.spring.restsoap.fixture.RahmenvertragFixture;
...
public class StammdatenRestControllerTest {
    ...
    public void testGetStammdaten_Found() throws Exception {
        when(repositoryMock.findByName("JUNIT-RV")).thenReturn(RahmenvertragFixture.buildDefaultRV("JUNIT-RV"));
        mvc.perform(MockMvcRequestBuilders.get("/v1/api/stammdaten")
                .param("name", "JUNIT-RV")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
